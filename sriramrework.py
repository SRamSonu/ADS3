...
def selected_data(df_years, countries, indicators):
    """
...
def heat_map(df, size=6):
    ...
    im = ax.matshow(corr, cmap='gist_stern_r')
    ...
    ax.set_title('Correlation Heatmap for selected Countrys and Indicators')
    plt.tight_layout()
...
if __name__ == '__main__':
    ...
    df = selected_data(df_years, countries, indicators)

    # normalize the data
    df_normalized = normalization_data(df)
...
plot_exp_growth(r"C:\Users\mouli\Downloads\worldbank.csv", [
